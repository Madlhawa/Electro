          ...
          <div class="main-content-container container-fluid px-4">
			...
			<%
				...
				for (int i = 0; i < docList.size(); i++) {
					...
					String con = (String)doc.getOrDefault("condition", "na");
              ...
              <div class="col-lg-6 col-sm-12 mb-4">
                <div class="card card-small card-post card-post--aside card-post--1">
                  ...
                  <div class="card-body" style="width:0%">
                    <h5 class="card-title" style="font-weight:400;color:#384158;">
                    ...
                    <%if(doc.getFieldValue("description")!=null){ %>
						<p class="card-text d-inline-block mb-3" style="width:100%; max-height:45px; overflow: hidden;margin-bottom: 1%!important;"><%=doc.getFieldValue("description")%></p>
					<%} %>
