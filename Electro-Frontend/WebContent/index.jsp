          ...
          <div class="error" style="height:100%">
			...
			<form style="width:100%" method="post" action="Find">
              <div class="input-group mb-3" style="margin-bottom:2%">
                <input type="text" name="squery" class="form-control" style="height:45px;font-size:19px" placeholder="Find anything..." aria-label="Recipient's username" aria-describedby="basic-addon2">
