      ...
      ">
        <main class="main-content col-lg-8 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          <div class="error" style="height:100%">
            <div class="error__content" style="width:60%">
              <h2 style="color:#384158;font-size:80px;padding-bottom:1%">Search<span style="color:#14bdee">it</span></h2>
              <!-- <p style="font-weight:200;font-size:20px;margin-bottom:2%">Find anything you want</p>  -->
			<form style="width:100%" method="post" action="Find">
              <div class="input-group mb-3" style="margin-bottom:2%">
                <input type="text" name="squery" class="form-control" style="height:45px;font-size:19px" placeholder="Find anything you want" aria-label="Recipient's username" aria-describedby="basic-addon2">
              ...
              <div class="row">
                <div class="col">
                  ...
                  <a href="about.html"><button type="button" class="mb-2 btn btn-sm btn-outline-secondary mr-1">About us</button></a>
