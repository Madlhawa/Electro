...
class BuyabansbotSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        pages = ["air-conditioners","apple-products","tv","audio","computers","refrigerators","washing-machines","home-appliances","kitchen-appliances","small-appliances","mobile-phones","watch","pos-system","furniture","faceshop","skechers","others"]
        for p in pages:
