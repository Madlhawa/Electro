...
class IkmanbotSpider(scrapy.Spider):
    ...
    start_urls = ['https://ikman.lk/en/ads']
    ...
    def parse(self, response):
        url = response.url
        for href in response.xpath("//div[@class='ui-accordion-item is-open'][1]/div/ul/li/ul[@class='ui-link-tree']/li/a/@href").extract():
            url1 = 'https://ikman.lk'+href
